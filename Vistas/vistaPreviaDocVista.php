	...
	<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid mt-4">
                		...
                		<h2 class="text-center fadeIn animated" id="txt">Vista previa - Matricular docentes</h2>

                        <table class="table">
                            <a href="../Controladores/matDocControlador.php">Regresar - Matricular docentes</a>
                            <thead>
                                <tr>
                                    <td>Nombre</td>
                                    <td>Especialidad</td>
                                    <td>Aula virtual a matricular</td>
                                </tr>
                            </thead>
                            <tbody>
                                    <tr>

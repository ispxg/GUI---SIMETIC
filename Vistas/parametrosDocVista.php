	...
	<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper" class="fadeIn animated">
            <div class="container-fluid mt-4">              
      		        <h2 class="text-center" id="txt">Seleccione parámetros - Docente</h2>
                    <p class="text-center">Según estos parámetros se matriculará a los docentes</p>
                    <div class="d-flex justify-content-center">
                        <img src="../Vistas/recursos/img/profesor.png">
                    </div>
                    <div class="row">
                        <div class="col-md-12 box">
                            <form action="matDocControlador.php" method="post">
                                 <div>
                                ...
                                <div>
                                    <select class="form-control mt-2">
                                        <option selected="" disabled="">Seleccione la Unidad Curricular</option>
                                        <option value="UC">Unidad curricular según PNF</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    <select class="form-control mt-2">
                                        ...
                                        <option value="1">Secciones creadas en Moodle</option>
                                    </select>
                                </div>
                                <input type="submit" name="" class="mt-2" value="Comenzar matriculación"></a>
                            </form>
                        </div>
                    </div>
                </div>

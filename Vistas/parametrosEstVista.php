	...
	<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper" class="fadeIn animated">
            <div class="container-fluid mt-4">              
      		        <h2 class="text-center" id="txt">Seleccione parámetros - Estudiante</h2>
                    <p class="text-center">Según estos parámetros se matriculará a los estudiantes</p>
                    <div class="d-flex justify-content-center">
                        <img src="../Vistas/recursos/img/estudiante.png">
                    </div> 
                    <div class="row">
                        <div class="col-md-12 box">
                            <form action="matEstControlador.php" method="post">
                                <div>

...
<head>
	...
	<title> Parametros categorias | SIMETIC</title>
	...
	<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper" class="fadeIn animated">
            <div class="container-fluid mt-4">              
      		        <h2 class="text-center" id="txt">Seleccionar parametros - Categorias</h2>
                    <p class="text-center">Según los siguientes parámetros usted gestionará diversas categorias</p>
                        ...
                        <div class="col-md-12 box">
                            <form action="gestionarcategoriasVista.php" method="post">
                              <div>
                                ...
                                <input type="submit" name="" class="mt-2" value="Comenzar gestion de categorias">
                            </form>
                        </div>
                    </div>
                </div>

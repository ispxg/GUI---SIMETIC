...
<body>
	...
	<div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper" style="background-color:#fff;">
            ...
            <br>
            <a href="../Vistas/parametrosDocVista.php" class="ml-3"><img src="../Vistas/recursos/img/flecha.png"> Matricular Docentes</a><br>
        ...
        <div id="page-content-wrapper" class="fadeIn animated">
            <div class="container-fluid mt-4">              
      		        <h2 class="text-center" id="txt">Seleccionar parametros</h2>

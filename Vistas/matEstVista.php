      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Por favor escoja el aula en la que se matricularan a los estudiantes.</p>
            <input type="checkbox" name="">IN3221 <br>
            <input type="checkbox" name="">IN1232 <br>
            <input type="checkbox" name="">IN4532 <br>

          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Crear aula virtual</button>
            <a href="../Vistas/vistaPreviaEstVista.php"><button type="button" class="btn btn-primary">Vista previa</button></a>
          </div>
        </div>
      </div>
    </div>
	...
	<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper" class="fadeIn animated">
            <div class="container-fluid mt-4">
                <h2 class="text-center" id="txt">Matricular estudiantes</h2>
            </div>
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="col-md-12">
                        <form action="#" method="post" id="formularioCSV">

	...
	<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid mt-4">
                		...
                		<h2 class="text-center fadeIn animated" id="txt">¿Qué desea hacer?</h2>


                        <div class="row fadeIn animated">
                            <div class="col-md-12 d-flex justify-content-center">
                                <a href="parametrosDocControlador.php"><input type="button" class="btn btn-primary btn-lg" value="Matricular docentes" id="md"></a>
                            </div>
                        </div>
                		<div class="row mt-2 fadeIn animated">
                			<div class="col-md-12 d-flex justify-content-center">
                				<a href="parametrosEstControlador.php"><input type="button" class="btn btn-primary btn-lg" value="Matricular estudiantes" id="me"></a>
                			</div>
                		</div>
                		

                		<a href="reportesControlador.php" id="gr"><p class="text-center mt-4 fadeIn animated">Solo quiero generar reportes</p></a>
